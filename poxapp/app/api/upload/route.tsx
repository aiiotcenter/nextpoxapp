...
//         const uniqueName = `image-${Date.now()}-${crypto.randomBytes(6).toString("hex")}${ext}`;
...
//           resolve(NextResponse.json({ filePath: `/uploads/${uniqueName}` }, { status: 200 }));
//         });

//         writeStream.on("error", (err) => {
//           reject(NextResponse.json({ error: "File write error" }, { status: 500 }));
//         });
//       });
